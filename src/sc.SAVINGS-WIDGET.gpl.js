...
var SC$ = (function (EQ, $) {
	...
	var createSavingsScheduleTable = function (schedule) {
		...
		if (L !== 0) {
			...
			strSchedule.append('<tr class="label rpt_footer"><td colspan="5">&quot;Net Change&quot; is change from prior period i.e. prior balance plus deposit, plus interest less withdrawal.</td><td colspan="2" class="right">AccurateCalculators.com</td></tr>');
			strSchedule.append('</tfoot>');
